...
exports.deploy = exports.isDeployingWebFramework = exports.TARGETS = exports.TARGET_PERMISSIONS = exports.VALID_DEPLOY_TARGETS = void 0;
...
const deploy = async function (targetNames, options, customContext = {}) {
    ...
    if (targetNames.includes("hosting") && (0, prepare_1.hasPinnedFunctions)(options)) {
        ...
        if (!targetNames.includes("functions")) {
            ...
            try {
                await (0, requirePermissions_1.requirePermissions)(options, exports.TARGET_PERMISSIONS["functions"]);
            }
            catch (e) {
    ...
    for (const targetName of targetNames) {
        const target = exports.TARGETS[targetName];
        if (!target) {
    ...
    try {
        ...
        Object.keys(exports.TARGETS).reduce((accum, t) => {
            accum[t] = "false";
            return accum;
        }, params);
